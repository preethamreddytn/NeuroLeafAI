...
document.addEventListener('DOMContentLoaded', function() {
    ...
    async function generateTextPdf(resultData, fileName) {
        ...
        pdf.text('NeuroLeafAI', margin, 12);
        pdf.setFontSize(11);
        ...
        pdf.text('© 2025 NeuroLeafAI. All Rights Reserved.', pageWidth / 2, footerY, { align: 'center' });
        ...
        perCardButtons.forEach(btn => {
            btn.addEventListener('click', async (e) => {
                ...
                try {
                    ...
                    const fileName = `NeuroLeafAI_Result_${idx}_${Date.now()}.pdf`;
    ...
    if (saveAllBtn) {
        saveAllBtn.addEventListener('click', async () => {
            ...
            try {
                ...
                pdf.save(`NeuroLeafAI_All_Results_${Date.now()}.pdf`);
